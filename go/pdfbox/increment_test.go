...
// `pdfbox/cos`. Its two other cases are not ported:
//
//   - testConcurrentModification downloads a PDF from issues.apache.org, and
//     the port does not fetch anything in a test.
//   - testSubsetting calls PDType0Font.load, which is font embedding —
//     unported, and claimed by track/font-embedding, whose task file names this
//     case.
//
// Both are recorded in migration/STATUS.md.
