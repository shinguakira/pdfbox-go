...
**This directory is outside the migration's own rules, and says so here rather
than in each file.**

[`AGENTS.md`](../../../AGENTS.md) says never to open a pull request against
`apache/pdfbox` or prepare a change for contribution upstream, and
...
Java, which is still the reference and is still never edited.
